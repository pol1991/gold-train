  ...
  <div class="container">
    <div class="row">
        <div id="" class="d-none col-12 d-lg-flex d-md-flex flex-row justify-content-center justify-content-lg-end">
            ...
            <a class="text-secondary text-decoration-none p-2 social-icon" href="<?php echo get_site_url(); ?>">
            ...
            <span class=" text-secondary text-decoration-none p-2" >Zadzwoń:</span>
            ...
            <span class=" text-secondary text-decoration-none p-2" >Napisz:</span>
            ...
            <div class="text-secondary text-decoration-none p-2" ><i class="fas fa-grip-lines-vertical"></i></div>
            <span class=" text-secondary text-decoration-none p-2" >Odwiedź:</span>
