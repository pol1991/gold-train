  ...
  <div class="container">
    <div class="row">
        <div id="" class="col-12 d-flex flex-row justify-content-center justify-content-lg-end">
            <a class="text-secondary text-decoration-none font-weight-bold p-2 social-icon" href=""><?php echo get_theme_mod('gold_train_brand_name', __( 'Brand Name', 'gold-train' ) ); ?></a>
